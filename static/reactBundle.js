  ...
  ...{
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/component.js": function anonymous(require, module, exports) {
      ...
      function processComponentDidUpdateLiftCircle(fiber) {
        var hasUpdateLifeCircle =
          fiber.instance.__pendingCallback__.length || (fiber.instance.componentDidUpdate && typeof fiber.instance.componentDidUpdate === "function");
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/dom.js": function anonymous(require, module, exports) {
      ...
      function updateDom(element, oldProps, newProps, fiber) {
        if (fiber.__isTextNode__) {
          ...
          Object.keys(oldProps)
            .filter(_domProps.isProperty)
            .filter((0, _domProps.isGone)(newProps))
            .forEach(function (key) {
          ...
          Object.keys(oldProps)
            .filter(_domProps.isStyle)
            .forEach(function (styleKey) {
              Object.keys(oldProps[styleKey] || _env.empty)
                .filter((0, _domProps.isGone)(newProps[styleKey] || _env.empty))
          ...
          Object.keys(newProps)
            .filter(_domProps.isEvent)
            .filter((0, _domProps.isNew)(oldProps, newProps))
            .forEach(function (key) {
          ...
          Object.keys(newProps)
            .filter(_domProps.isStyle)
            .forEach(function (styleKey) {
              Object.keys(newProps[styleKey] || _env.empty)
                .filter((0, _domProps.isNew)(oldProps[styleKey] || _env.empty, newProps[styleKey]))
                .forEach(function (styleName) {
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/element.js": function anonymous(require, module, exports) {
      ...
      function memo(MemoRender) {
        ...
        var MemoObject = {
          type: _symbol.Memo,
          render:
            (_MemoRender$prototype = MemoRender.prototype) !== null && _MemoRender$prototype !== void 0 && _MemoRender$prototype.isMyReactComponent
              ? function (props) {
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/share.js": function anonymous(require, module, exports) {
      ...
      exports.singleElement =
        exports.isUnitlessNumber =
        exports.createRef =
        exports.autoSortByDeepIndexFiberArray =
        exports.MyReactTypeInternalInstance =
          void 0;
      ...
      var autoSortByDeepIndexFiberArray = new PriorityQueueByArrayAboutJudge(
        function (o1, o2) {
          return o1 > o2;
        },
        function (fiber) {
              ...
              if (_env.enableAllCheck.current && !this.__validType__) {
                ...
                if (this.__isForwardRef__) {
                  ...
                  if (
                    ...
                    (_this$type$render$pro = this.type.render.prototype) !== null &&
                    _this$type$render$pro !== void 0 &&
                    _this$type$render$pro.isMyReactComponent
                  ) {
                ...
                if (_this.__INTERNAL_EVENT_STATE__[cacheEventName]) {
                  ...
                  var handler = function handler() {
                    ...
                    if (_env.enableControlComponent.current) {
                      if (
                        _this.__isPlainNode__ &&
                        _this.__vdom__.type === "input" && // todo more event, like change
                        event === "input" &&
                        "value" in _this.memoProps
                      ) {
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/core.js": function anonymous(require, module, exports) {
      ...
      function transformChildrenFiber(parentFiber, _children) {
        ...
        var previousRenderChildren =
          ((_parentFiber$fiberAlt = parentFiber.fiberAlternate) === null || _parentFiber$fiberAlt === void 0
            ? void 0
        ...
        while (index < children.length || index < previousRenderChildren.length) {
          ...
          var newFiber = isNewChildren
            ? (0, _coreTool.getNewFiberWithInitial)(newChild, parentFiber)
            : (0, _coreTool.getNewFiberWithUpdate)(newChild, parentFiber, previousRenderChild, assignPreviousRenderChild);
            ...
            if (fiber.__isPlainNode__ || fiber.__isPortal__) {
              ...
              if (_beforeDom) {
                insertBefore(
                  childFiber,
                  _beforeDom,
                  (0, _domTool.getDom)(fiber, function (f) {
      ...
      function commitUpdate(currentFiber, parentDom) {
        if (currentFiber.dom) {
          ...
          if (currentFiber.effect === "PLACEMENT") {
            ...
            (0, _dom.updateDom)(
              currentFiber.dom,
              currentFiber.__isTextNode__ ? _env.empty : currentFiber.fiberAlternate.__vdom__.props,
              currentFiber.__isTextNode__ ? _env.empty : currentFiber.__vdom__.props,
              currentFiber
            );
          }
      ...
      function runUpdate() {
        ...
        allUpdateArray.forEach(function (fiber) {
          ...
          if (fiber.mount) {
            commitUpdate(
              fiber,
              (0, _domTool.getDom)(fiber.fiberParent, function (fiber) {
      ...
      function getNewFiberWithUpdate(newVDom, parentFiber, previousRenderChild, matchedPreviousRenderChild) {
        ...
        if (isSameType) {
          ...
          if (
            ...
            (0, _tools.isNormalEqual)(matchedPreviousRenderChild.__vdom__.props.value, newVDom.props.value)
          ) {
            return (0, _fiber.updateFiberNodeWithPosition)(matchedPreviousRenderChild, parentFiber, previousRenderChild, newVDom);
          }
      ...
      function mountStart() {
        try {
          mountLoop(
            ...
            (0, _domTool.getDom)(_env.rootFiber.current.fiberParent, function (fiber) {
              return fiber.fiberParent;
            }) || _env.rootContainer.current
          );
        } catch (e) {
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/domHydrate.js": function anonymous(require, module, exports) {
        ...
        Object.keys(props)
          ...
          .forEach(function (key) {
            ...
            if (key === "className") {
              if (dom[key] !== props[key]) {
                console.warn(
                  ...
                  "server: ".concat(dom[key], ", "),
                  "client: ".concat(props[key], " \n"),
            ...
            if (
              props[key] !== null &&
              props[key] !== undefined &&
              dom.getAttribute(key) !== ((_props$key = props[key]) === null || _props$key === void 0 ? void 0 : _props$key.toString())
            ) {
              var _props$key2;

              console.warn(
                "hydrate warning, dom attrs not match from template: ",
                "server: ".concat(dom.getAttribute(key), ", "),
                "client: ".concat((_props$key2 = props[key]) === null || _props$key2 === void 0 ? void 0 : _props$key2.toString(), " \n"),
                (0, _debug.logFiber)(fiber)
              );
      ...
      function hydrateDom(fiber, dom) {
        ...
        domEventHydrate(
          fiber,
          dom,
          ((_fiber$__vdom__2 = fiber.__vdom__) === null || _fiber$__vdom__2 === void 0 ? void 0 : _fiber$__vdom__2.props) || _env.empty
        );
        domStyleHydrate(
          fiber,
          dom,
          ((_fiber$__vdom__3 = fiber.__vdom__) === null || _fiber$__vdom__3 === void 0 ? void 0 : _fiber$__vdom__3.props) || _env.empty
        );
        return dom;
      }
      /**
        ...
        if (fiber.__isTextNode__) {
          ...
          if (fiber.__vdom__.toString() !== dom.textContent) {
            console.warn(
              ...
              "server: ".concat(dom.textContent, ", "),
              "client: ".concat(fiber.__vdom__.toString()),
              (0, _debug.logFiber)(fiber)
            );
            return false;
          }
