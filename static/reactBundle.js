  ...
  ...{
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/component.js": function anonymous(require, module, exports) {
      ...
      function processComponentContextUpdate(fiber) {
        ...
        if (!fiber.instance.__context__ || (fiber.instance.__context__ && !fiber.instance.__context__.mount)) {
          ...
          Object.keys(newProps)
            ...
            .forEach(function (styleKey) {
              Object.keys(newProps[styleKey] || {})
                .filter((0, _tools.isNew)(oldProps[styleKey] || _env.empty, newProps[styleKey]))
                .forEach(function (styleName) {
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/tools.js": function anonymous(require, module, exports) {
      ...
      exports.getNativeEventName =
        ...
        exports.Provider =
        exports.PriorityQueueByArrayAboutJudge =
        exports.Portal =
        exports.Memo =
        exports.Fragment =
        exports.ForwardRef =
      ...
      function transformChildrenFiber(parentFiber, _children) {
        ...
        while (index < children.length || index < previousRenderChildren.length) {
          ...
          var newFiber = isNewChildren
            ...
            : getNewFiberWithUpdate(newChild, parentFiber, previousRenderChild, assignPreviousRenderChild, isSameType);
    ...
    "/home/mrwang/Documents/Web/Code/D_React/MyReact/lib/Core/lib/env.js": function anonymous(require, module, exports) {
      ...
      var pendingAsyncModifyFiberArray = (0, _tools.createRef)(
        new _tools.PriorityQueueByArrayAboutJudge(
          function (o1, o2) {
            return o1 > o2;
          },
          function (fiber) {
            ...
            if (fiber.__isPlainNode__ || fiber.__isPortal__) {
              ...
              if (_beforeDom) {
                insertBefore(
                  childFiber,
                  _beforeDom,
                  (0, _tools.getDom)(fiber, function (f) {
      ...
      function mountStart() {
        try {
          mountLoop(
            ...
            (0, _tools.getDom)(_env.rootFiber.current.fiberParent, function (fiber) {
              return fiber.fiberParent;
            }) || _env.rootContainer.current
          );
        } catch (e) {
